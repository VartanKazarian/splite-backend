...
const DETAILS = {
  ...
  BILL_ALREADY_SERVED: { servedBy: 'uuid -- who the bill is already attributed to' },
  ...
  PRODUCT_IMAGE_FILE_TOO_LARGE: { maxBytes: 'integer -- the upload ceiling' },
